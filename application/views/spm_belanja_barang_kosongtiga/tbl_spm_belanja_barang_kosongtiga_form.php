	...
	<section class="content">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo strtoupper($button) ?> DATA TBL_SPM_BELANJA_BARANG_KOSONGTIGA</h3>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						...
						<td> <textarea class="form-control" rows="3" name="tgl_spm" id="tgl_spm" placeholder="Tgl Spm"><?php echo $tgl_spm; ?></textarea></td>
					</tr>
					...
					<tr>
						<td></td>
						<td>
							<input type="hidden" name="id_spmbptiga" value="<?php echo $id_spmbptiga; ?>" /> 
							<button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
							<a href="<?php echo site_url('spm_belanja_barang_kosongtiga') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
