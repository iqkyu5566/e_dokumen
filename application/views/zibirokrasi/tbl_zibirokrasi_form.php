	...
	<section class="content">
		<div class="box box-warning box-solid">
			<div class="box-header with-border">
				<h3 class="box-title"><?php echo strtoupper($button) ?> DATA TBL_ZIBIROKRASI</h3>
			</div>
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					...
					<tr>
						<td></td>
						<td>
							<input type="hidden" name="id_zibirokrasi" value="<?php echo $id_zibirokrasi; ?>" /> 
							<button type="submit" class="btn btn-danger"><i class="fa fa-floppy-o"></i> <?php echo $button ?></button> 
							<a href="<?php echo site_url('zibirokrasi') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
